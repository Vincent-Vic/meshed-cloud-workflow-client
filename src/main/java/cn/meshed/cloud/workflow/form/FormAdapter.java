...
public interface FormAdapter {
    ...
    @GetMapping("/get/schema/{formId}")
    SingleResponse<String> getSchemaById(@Parameter(description = "表单ID") @PathVariable("formId") String formId);
     ...
     */
    @Operation(summary = "获取表单设计数据")
    @GetMapping("/get/schema/key/{key}")
    SingleResponse<String> getSchemaByKey(@Parameter(description = "表单唯一标识") @PathVariable("key") String key);
     ...
     * @return {@link Response}
     */
    @Operation(summary = "恢复表单")
    @PostMapping("/resume/{formId}")
    Response resume(@Parameter(description = "表单编码") @PathVariable("formId") String formId);
    ...
    Response delete(@Parameter(description = "表单编码") @PathVariable("formId") String formId);
